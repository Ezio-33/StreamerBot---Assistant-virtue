...
# Fonction pour sauvegarder une copie de sauvegarde d'un fichier
...
# Fonction pour trouver des questions similaires à une question donnée
...
def update_intents_with_feedback(intents, user_feedback):
    for feedback in user_feedback:
        ...
        if similar_questions:
            # Mettre à jour une intention existante
...
def main():
    ...
    # Sauvegarder une copie de sauvegarde du fichier des intentions
    backup_file(INTENTS_PATH)

    # Mettre à jour les intentions avec les retours des utilisateurs
    updated_intents = update_intents_with_feedback(intents, user_feedback)

    # Sauvegarder les intentions mises à jour
    save_json_file(updated_intents, INTENTS_PATH)

    print(Fore.GREEN + "Intents file updated successfully.")

    # Effacer les retours des utilisateurs après traitement
